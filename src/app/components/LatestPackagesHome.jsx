    ...
    return (
        <div className="w-full mx-auto py-12 ">
            ...
            <div className="flex flex-col md:flex-row gap-5 items-center justify-between my-10 bg-linear-to-r from-sky-500 to-blue-700 p-10 rounded-2xl shadow-lg">
                <div>
                    <p className="text-white mb-2 font-bold text-center lg:text-left">Search Tours</p>
                ...
                <div>
                    <p className="text-white mb-2 font-bold text-center lg:text-left">Sort Tours</p>
                    <select
                        value={sort}
                        onChange={(e) => {
            ...
            <div className="flex justify-center mt-10 gap-2">
                <button
                    ...
                    className="btn px-4 py-2 bg-base-300 rounded disabled:opacity-50"
                >
                    Prev
                </button>
